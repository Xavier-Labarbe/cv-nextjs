      ...
      <div className={"home__container container grid"}>
        <div className={"home__content grid"}>
          <div className={"home__social"}>
            <a
              href="https://www.linkedin.com/in/xavier-labarbe/"
              className={"home__social-icon"}
            >
              <i className="uil uil-linkedin" />
            </a>
            <a
              href="https://github.com/Xavier-Labarbe"
              className={"home__social-icon"}
            >
          ...
          <div className={"home__data"}>
            ...
            <h3 className={"home__subtitle"}>
              Je recherche un contrat de professionalisation
            </h3>
            <p className={"home__description"}>
              Spécialisé dans le développement, je recherche actuellement une
              entreprise afin de m'accueuillir en tant que Web Developper ou
              Chef de projet Web/Digital pour réaliser la dernière année de mon
              cursus ingénieur.
            </p>
